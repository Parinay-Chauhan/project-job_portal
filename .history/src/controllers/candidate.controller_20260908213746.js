...
const addExperience = asyncHandler(async (req, res) => {
  ...
  if (!company?.trim() || !title?.trim() || !from) {
    throw new ApiError(400, "Company, title and start date are required");
}
...
export { createCandidateProfile, getCandidateProfile, updateCandidateProfile, addExperience };
